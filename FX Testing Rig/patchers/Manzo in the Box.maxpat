...
, 			{
				"box" : 				{
					...
					"fontsize" : 14.0,
					"id" : "obj-63",
					"items" : [ "Feedback Delay.gendsp", ",", "Flanger.gendsp", ",", "Intro to Gen Default FX Patch.gendsp", ",", "LPF Camp Multi-FX Pedal.gendsp", ",", "Multi-Effects Pedal.gendsp", ",", "Tremolo.gendsp" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
